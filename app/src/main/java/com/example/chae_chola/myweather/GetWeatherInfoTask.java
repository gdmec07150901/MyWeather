package com.example.chae_chola.myweather;
...
/**
 * Created by chae_choLA on 2016/12/15.
 */
public class GetWeatherInfoTask extends AsyncTask<String,Void,List<Map<String,Object>>> {
    ...
    private static String key = "key=12eac4aecedb4c6dacfff2316756b3ab";
            ...
            if (response.getStatusLine().getStatusCode()==200){
                ...
                if (jsondata.getInt("resultcode")==200){
                    ...
                    for (int i = 0;i<7;i++){
                        ...
                        item.put("temperature",weatObject.getString("temperture"));
                        ...
                        JSONObject wid = weatObject.getJSONObject("weahter_id");
